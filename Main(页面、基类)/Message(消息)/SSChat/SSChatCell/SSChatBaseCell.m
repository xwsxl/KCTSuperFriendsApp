...
-(void)setLayout:(SSChatMessagelLayout *)layout{
    ...
    _mMessageTimeLab.text = [NSString achieveDayFormatByTimeString:layout.message.messageTime withOutTimeDetail:YES];
    ...
    [self.mHeaderImgBtn sd_setImageWithURL:KNSPHOTOURL(layout.message.headerImgurl) forState:UIControlStateNormal];

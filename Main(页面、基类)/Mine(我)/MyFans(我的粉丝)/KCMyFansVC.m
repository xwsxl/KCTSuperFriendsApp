...
@interface KCMyFansVC ()<UITableViewDelegate,UITableViewDataSource>
...
{
    [super setSubViews];
    XLNaviView *Navi=[[XLNaviView alloc] initWithMessage:@"我的粉丝" ImageName:@""];
